...
export interface AnalyticsTemplateProps extends cdk.StackProps {
  /**
   */
 ...
 */
export class AnalyticsTemplate extends cdk.Stack {
  public readonly kinesisStreamArn;
  public readonly kinesisStreamId;
  public readonly kinesisStreamShardCount;

  public constructor(scope: cdk.App, id: string, props: AnalyticsTemplateProps) {
