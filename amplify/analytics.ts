...
export interface AnalyticsTemplateProps extends cdk.NestedStackProps {
  /**
   */
...
/**
 * {"createdOn":"Mac","createdBy":"Amplify","createdWith":"14.1.1","stackType":"analytics-Kinesis","metadata":{"whyContinueWithGen1":"Prefer not to answer"}}
 */
export class AnalyticsTemplate extends cdk.NestedStack {
  public readonly kinesisStreamArn;
  public readonly kinesisStreamId;
  public readonly kinesisStreamShardCount;

  public constructor(scope: cdk.Stack, id: string, props: AnalyticsTemplateProps) {
    ...
    // Conditions
    // const shouldNotCreateamplifyEnvResources = props.amplifyEnv! === 'NONE';
    new cdk.CfnCondition(this, 'ShouldNotCreateEnvResources', {
      expression: cdk.Fn.conditionEquals(props.amplifyEnv, 'NONE'),
    });
